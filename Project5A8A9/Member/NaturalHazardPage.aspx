<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="NaturalHazardPage.aspx.cs" Inherits="Project5A8A9.Member.NaturalHazardPage" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div><h1 style="text-align:center">Welcome to Natural Hazardz  Service page.</h1></div>
    <div>
    <p>
