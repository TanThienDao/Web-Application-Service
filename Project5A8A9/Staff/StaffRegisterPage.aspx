<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="StaffRegisterPage.aspx.cs" Inherits="Project5A8A9.Staff.StaffRegisterPage" %>
<%@ Register TagPrefix="myControl" TagName="ImgVerifier" src="ImgVerifier.ascx"%>

<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    &nbsp;&nbsp;
    <div>   
        <h2 style="text-align:center">Welcome to Register page for Staff.</h2>
    </div>
    &nbsp;&nbsp;
